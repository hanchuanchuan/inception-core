...
import (
	...
	"github.com/hanchuanchuan/inception-core/domain"
	...
	plannercore "github.com/hanchuanchuan/inception-core/planner/core"
...
func (s *testIntegrationSuite) TestBuiltin(c *C) {
	...
	// for regexp, rlike
	// https://github.com/hanchuanchuan/inception-core/issues/4080
	tk.MustExec(`drop table if exists t;`)
