...
func (s *testEvaluatorSuite) TestDateFormat(c *C) {
	...
	// Test case for https://github.com/hanchuanchuan/inception-core/issues/2908
...
func (s *testEvaluatorSuite) TestUnixTimestamp(c *C) {
	...
	// https://github.com/hanchuanchuan/inception-core/issues/2496
	...
	// https://github.com/hanchuanchuan/inception-core/issues/2852
