...
func (s *inceptionCore) checkAlterUseOsc(t *TableInfo) {
...
func (s *inceptionCore) mysqlComputeSqlSha1(r *Record) {
...
func (s *inceptionCore) mysqlExecuteAlterTableOsc(r *Record) {
...
func (s *inceptionCore) mysqlExecuteAlterTableGhost(r *Record) {
...
func (s *inceptionCore) execCommand(r *Record, commandName string, params []string) bool {
...
func (s *inceptionCore) mysqlAnalyzeOscOutput(out string, p *util.OscProcessInfo) {
...
func (s *inceptionCore) mysqlAnalyzeGhostOutput(out string, p *util.OscProcessInfo) {
...
func (s *inceptionCore) getAlterPartSql(sql string) (string, bool) {
