...
func (s *inceptionCore) printCommand(ctx context.Context, stmtNode ast.StmtNode,
...
func (s *inceptionCore) printInsert(node *ast.InsertStmt, sql string) {
...
func (s *inceptionCore) printSelectItem(node ast.ResultSetNode) bool {
...
func (s *inceptionCore) printSubSelectItem(node *ast.SelectStmt) bool {
