...
import (
	...
	"github.com/hanchuanchuan/inception-core/owner"
...
type inceptionCore struct {
	// processInfo is used by ShowProcess(), and should be modified atomically.
	processInfo atomic.Value
	txn         session.TxnState
...
func (s *inceptionCore) Audit(ctx context.Context, sql string) ([]Record, error) {
...
func (s *inceptionCore) RunExecute(ctx context.Context, sql string) ([]Record, error) {
	if err := s.init(); err != nil {
		return nil, err
	}
	defer s.clear()
...
func (s *inceptionCore) audit(ctx context.Context, sql string) (err error) {
...
func (s *inceptionCore) makeNewResult() ([]Record, error) {
...
func (s *inceptionCore) makeResult() (recordSets []sqlexec.RecordSet, err error) {
	if s.opt != nil && s.opt.Print && s.printSets != nil {
		return s.printSets.Rows(), nil
	} else if s.opt != nil && s.opt.split && s.splitSets != nil {
		s.addNewSplitNode()
...
func (s *inceptionCore) isRunToTiDB(stmtNode ast.StmtNode) (is bool, isFlush bool) {
...
func (s *inceptionCore) needDataSource(stmtNode ast.StmtNode) bool {
	switch node := stmtNode.(type) {
	case *ast.ShowStmt:
		if node.IsInception {
			return false
...
func (s *inceptionCore) processCommand(ctx context.Context, stmtNode ast.StmtNode,
...
// splitCommand 分隔功能实现
func (s *inceptionCore) splitCommand(ctx context.Context, stmtNode ast.StmtNode,
...
func (s *inceptionCore) executeCommit(ctx context.Context) {
...
func (s *inceptionCore) mysqlBackupSql(record *Record, longDataType bool) {
...
func (s *inceptionCore) mysqlExecuteBackupSqlForDDL(record *Record) {
...
// longDataType 为true表示字段类型已更新,否则为text,需要在写入时自动截断
func (s *inceptionCore) mysqlExecuteBackupInfoInsertSql(record *Record, longDataType bool) int {
...
func (s *inceptionCore) mysqlBackupSingleDDLStatement(record *Record) {

}

func (s *inceptionCore) mysqlBackupSingleStatement(record *Record) {

}

func (s *inceptionCore) checkSqlIsDML(record *Record) bool {
	switch record.Type.(type) {
...
// longDataType 为true表示字段类型已更新,否则为text,需要在写入时自动截断
func (s *inceptionCore) mysqlCreateBackupTable(record *Record) (longDataType bool) {
...
func (s *inceptionCore) checkBackupTableSqlStmtColumnType(dbname string) (longDataType bool) {
...
func (s *inceptionCore) mysqlCreateSqlBackupTable(dbname string) string {
...
func (s *inceptionCore) mysqlCreateSqlFromTableInfo(dbname string, ti *TableInfo) string {
...
func (s *inceptionCore) mysqlRealQueryBackup(sql string) (err error) {
...
func (s *inceptionCore) getRemoteBackupDBName(record *Record) string {
...
func (s *inceptionCore) checkSqlIsDDL(record *Record) bool {
...
func (s *inceptionCore) executeAllStatement(ctx context.Context) {
...
func (s *inceptionCore) executeTransaction(records []*Record) int {
	if records == nil {
		return 2
	}
...
func (s *inceptionCore) executeRemoteCommand(record *Record) int {
...
func (s *inceptionCore) sqlStatisticsIncrement(record *Record) {
...
func (s *inceptionCore) sqlStatisticsSave() {
	if !s.opt.execute || !s.Inc.EnableSqlStatistic || s.statistics == nil {
		return
	}
...
func (s *inceptionCore) createStatisticsTable() {
...
func (s *inceptionCore) executeRemoteStatement(record *Record) {
...
func (s *inceptionCore) executeRemoteStatementAndBackup(record *Record) {
...
func (s *inceptionCore) mysqlFetchMasterBinlogPosition() *MasterStatus {
...
func (s *inceptionCore) checkBinlogFormatIsRow() bool {
...
func (s *inceptionCore) checkBinlogRowImageIsFull() bool {
...
func (s *inceptionCore) mysqlServerVersion() {
	...
	('innodb_large_prefix','version','sql_mode','lower_case_table_names',
	'wsrep_on','explicit_defaults_for_timestamp');`
...
func (s *inceptionCore) fetchThreadID() uint32 {
...
func (s *inceptionCore) fetchTranThreadID(tx *gorm.DB) uint32 {
...
func (s *inceptionCore) modifyBinlogFormatRow() {
...
// 设置超时时间
func (s *inceptionCore) modifyWaitTimeout() {
...
func (s *inceptionCore) modifyBinlogRowImageFull() {
...
func (s *inceptionCore) setSqlSafeUpdates() {
...
func (s *inceptionCore) checkBinlogIsOn() bool {
...
func (s *inceptionCore) checkIsReadOnly() bool {
...
func (s *inceptionCore) LoadOptions(opt SourceOptions) error {
	s.opt = &opt
	// return s.parseOptions()
	return nil
}

func (s *inceptionCore) parseOptions() error {
...
func (s *inceptionCore) getTLSConfig() (string, error) {
	tlsValue := "false"
...
func (s *inceptionCore) parseIncLevel() {
...
func (s *inceptionCore) checkTruncateTable(node *ast.TruncateTableStmt, sql string) {
...
func (s *inceptionCore) checkDropTable(node *ast.DropTableStmt, sql string) {
...
func (s *inceptionCore) mysqlShowTableStatus(t *TableInfo) {
...
func (s *inceptionCore) mysqlForeignKeys(t *TableInfo) (keys []string) {
...
func (s *inceptionCore) mysqlGetTableSize(t *TableInfo) {
...
func (s *inceptionCore) mysqlShowCreateTable(t *TableInfo) {
...
func (s *inceptionCore) mysqlShowCreateDatabase(name string) {
...
func (s *inceptionCore) checkRenameTable(node *ast.RenameTableStmt, sql string) {
...
func (s *inceptionCore) checkCreateTable(node *ast.CreateTableStmt, sql string) {
...
func (s *inceptionCore) checkTableOptions(options []*ast.TableOption, table string, isCreate bool) {
...
func (s *inceptionCore) checkMustHaveColumns(table *TableInfo) {
...
func (s *inceptionCore) buildTableInfo(node *ast.CreateTableStmt) *TableInfo {
...
func (s *inceptionCore) checkAlterTable(node *ast.AlterTableStmt, sql string) {
...
func (s *inceptionCore) checkAlterTableAlterColumn(t *TableInfo, c *ast.AlterTableSpec) {
...
func (s *inceptionCore) checkAlterTableRenameIndex(t *TableInfo, c *ast.AlterTableSpec) {
...
func (s *inceptionCore) checkAlterTableRenameTable(t *TableInfo, c *ast.AlterTableSpec) {
...
func (s *inceptionCore) checkChangeColumn(t *TableInfo, c *ast.AlterTableSpec) {
	log.Debug("checkChangeColumn")

	s.checkModifyColumn(t, c)
}

func (s *inceptionCore) checkModifyColumn(t *TableInfo, c *ast.AlterTableSpec) {
...
func (s *inceptionCore) hasError() bool {
	if s.myRecord.ErrLevel == 2 ||
...
func (s *inceptionCore) hasErrorBefore() bool {
	if s.recordSets.MaxLevel == 2 ||
		(s.recordSets.MaxLevel == 1 && !s.opt.ignoreWarnings) {
		return true
	}
...
func (s *inceptionCore) mysqlCheckField(t *TableInfo, field *ast.ColumnDef) {
...
func (s *inceptionCore) checkIndexAttr(tp ast.ConstraintType, name string,
...
func (s *inceptionCore) checkCreateForeignKey(t *TableInfo, c *ast.Constraint) {
	// log.Infof("%#v", c)
...
func (s *inceptionCore) checkDropForeignKey(t *TableInfo, c *ast.AlterTableSpec) {
...
func (s *inceptionCore) checkAlterTableDropIndex(t *TableInfo, indexName string) bool {
...
func (s *inceptionCore) checkDropPrimaryKey(t *TableInfo, c *ast.AlterTableSpec) {
	log.Debug("checkDropPrimaryKey")

	s.checkAlterTableDropIndex(t, "PRIMARY")
}

func (s *inceptionCore) checkAddColumn(t *TableInfo, c *ast.AlterTableSpec) {
...
func (s *inceptionCore) checkDropColumn(t *TableInfo, c *ast.AlterTableSpec) {
...
// 当删除列,变更列顺序时, 重新保存表结构
func (s *inceptionCore) cacheTableSnapshot(t *TableInfo) *TableInfo {
...
func (s *inceptionCore) mysqlDropColumnRollback(field FieldInfo) {
	if s.opt.check {
		return
	}
...
func (s *inceptionCore) checkDropIndex(node *ast.DropIndexStmt, sql string) {
...
func (s *inceptionCore) checkCreateIndex(table *ast.TableName, IndexName string,
...
func (s *inceptionCore) checkAddConstraint(t *TableInfo, c *ast.AlterTableSpec) {
...
func (s *inceptionCore) checkDBExists(db string, reportNotExists bool) bool {
...
func (s *inceptionCore) checkInsert(node *ast.InsertStmt, sql string) {
...
func (s *inceptionCore) getTableList(tableList []*ast.TableSource) ([]*TableInfo, bool) {
	var tableInfoList []*TableInfo
...
func (s *inceptionCore) subSelectColumns(node ast.ResultSetNode) (int, error) {
...
func (s *inceptionCore) getSubSelectColumns(node ast.ResultSetNode) []string {
	columns := []string{}
...
func (s *inceptionCore) checkDropDB(node *ast.DropDatabaseStmt, sql string) {
...
func (s *inceptionCore) executeInceptionSet(node *ast.InceptionSetStmt, sql string) ([]sqlexec.RecordSet, error) {
...
func (s *inceptionCore) setVariableValue(t reflect.Type, values reflect.Value,
...
func (s *inceptionCore) setLevelValue(t reflect.Type, values reflect.Value,
	name string, value *ast.ValueExpr) error {
...
func (s *inceptionCore) checkUInt64SystemVar(name, value string, min, max uint64) (string, error) {
	if value[0] == '-' {
...
func (s *inceptionCore) checkInt64SystemVar(name, value string, min, max int64) (string, error) {
...
func (s *inceptionCore) setConfigValue(name string, field reflect.Value, value *types.Datum) error {
...
func (s *inceptionCore) showVariables(node *ast.ShowStmt, obj interface{}, res *VariableSets) {
...
func (s *inceptionCore) executeLocalShowVariables(node *ast.ShowStmt) ([]sqlexec.RecordSet, error) {
...
func (s *inceptionCore) executeLocalShowProcesslist(node *ast.ShowStmt) ([]sqlexec.RecordSet, error) {
...
func (s *inceptionCore) checkColumnName(expr ast.ExprNode, colNames []string) (colIndex int, err error) {
	colIndex = -1
...
// filterExprNode: 条件筛选
func (s *inceptionCore) filterExprNode(expr ast.ExprNode, colNames []string, values []string) (bool, error) {
	switch x := expr.(type) {
	case *ast.BinaryOperationExpr:
		switch x.Op {
		case opcode.EQ:
...
// filter: 条件筛选
func (s *inceptionCore) filter(expr []ast.ExprNode, colNames []string, value []string) (bool, error) {
	for _, e := range expr {
...
func (s *inceptionCore) executeLocalShowLevels(node *ast.ShowStmt) ([]sqlexec.RecordSet, error) {
...
func (s *inceptionCore) executeLocalShowOscProcesslist(node *ast.ShowOscStmt) ([]sqlexec.RecordSet, error) {
...
func (s *inceptionCore) executeLocalOscKill(node *ast.ShowOscStmt) ([]sqlexec.RecordSet, error) {
	pl := s.sessionManager.ShowOscProcessList()
...
func (s *inceptionCore) executeLocalOscPause(node *ast.ShowOscStmt) ([]sqlexec.RecordSet, error) {
	pl := s.sessionManager.ShowOscProcessList()
...
func (s *inceptionCore) executeLocalOscResume(node *ast.ShowOscStmt) ([]sqlexec.RecordSet, error) {
	pl := s.sessionManager.ShowOscProcessList()
...
func (s *inceptionCore) executeInceptionShow(sql string) ([]sqlexec.RecordSet, error) {
...
func (s *inceptionCore) checkCreateDB(node *ast.CreateDatabaseStmt, sql string) {
...
func (s *inceptionCore) checkCharset(charset string) bool {
...
func (s *inceptionCore) checkCollation(collation string) bool {
...
func (s *inceptionCore) checkEngine(engine string) bool {
...
func (s *inceptionCore) checkChangeDB(node *ast.UseStmt, sql string) {
...
func (s *inceptionCore) getExplainInfo(sql string, sqlId string) {
...
func (s *inceptionCore) getRealRowCount(sql string, sqlId string) {
...
func (s *inceptionCore) explainOrAnalyzeSql(sql string) {
...
func (s *inceptionCore) AnlyzeExplain(rows []ExplainInfo) {
	r := s.myRecord
	if len(rows) > 0 {
		r.AffectedRows = rows[0].Rows
	}
...
func (s *inceptionCore) checkUpdate(node *ast.UpdateStmt, sql string) {
...
func (s *inceptionCore) checkColumnTypeImplicitConversion(e *ast.BinaryOperationExpr, tables []*TableInfo) {
...
func (s *inceptionCore) checkItem(expr ast.ExprNode, tables []*TableInfo) bool {
...
// checkFieldItem 检查字段
func (s *inceptionCore) checkFieldItem(name *ast.ColumnName, tables []*TableInfo) bool {
	found := false
	db := name.Schema.L
...
func (s *inceptionCore) checkFuncItem(f *ast.FuncCallExpr, tables []*TableInfo) bool {
...
func (s *inceptionCore) checkAggregateFuncItem(f *ast.AggregateFuncExpr, tables []*TableInfo) bool {
...
func (s *inceptionCore) checkDelete(node *ast.DeleteStmt, sql string) {
...
func (s *inceptionCore) QueryTableFromDB(db string, tableName string, reportNotExists bool) []FieldInfo {
	if db == "" {
		db = s.DBName
	}
	var rows []FieldInfo
...
func (s *inceptionCore) QueryIndexFromDB(db string, tableName string, reportNotExists bool) []*IndexInfo {
	if db == "" {
		db = s.DBName
	}
	var rows []*IndexInfo
...
func (s *inceptionCore) AppendErrorMessage(msg string) {
...
func (s *inceptionCore) AppendWarning(number ErrorCode, values ...interface{}) {
	if s.stage == StageBackup {
		s.myRecord.Buf.WriteString("Backup: ")
	} else if s.stage == StageExec {
		s.myRecord.Buf.WriteString("Execute: ")
...
func (s *inceptionCore) AppendErrorNo(number ErrorCode, values ...interface{}) {
	r := s.myRecord
...
func (s *inceptionCore) checkKeyWords(name string) {
	if name != strings.ToUpper(name) {
		s.AppendErrorNo(ErrIdentifierUpper, name)
	}
...
func (s *inceptionCore) checkInceptionVariables(number ErrorCode) bool {
	switch number {
...
func (s *inceptionCore) getTableFromCache(db string, tableName string, reportNotExists bool) *TableInfo {
	if db == "" {
		db = s.DBName
	}
...
func (s *inceptionCore) cacheNewTable(t *TableInfo) {
	if t.Schema == "" {
		t.Schema = s.DBName
	}
	key := fmt.Sprintf("%s.%s", t.Schema, t.Name)
...
func (s *inceptionCore) buildNewColumnToCache(t *TableInfo, field *ast.ColumnDef) *FieldInfo {
...
func (s *inceptionCore) copyTableInfo(t *TableInfo) *TableInfo {
	p := &TableInfo{}
...
func (s *inceptionCore) checkSelectItem(node ast.ResultSetNode, hasWhere bool) []*TableInfo {
	if node == nil {
		return nil
	}
...
func (s *inceptionCore) checkSubSelectItem(node *ast.SelectStmt) []*TableInfo {
...
func (s *inceptionCore) getTableInfoList(node ast.ResultSetNode) []*TableInfo {
	if node == nil {
		return nil
	}
...
func (s *inceptionCore) getTableInfoByTableSource(tableList []*ast.TableSource) (tableInfoList []*TableInfo) {
...
func (s *inceptionCore) isMiddleware() bool {
	return s.opt.middlewareExtend != ""
}

func (s *inceptionCore) executeKillStmt(node *ast.KillStmt) ([]sqlexec.RecordSet, error) {
...
func (s *inceptionCore) checkFingerprint(sql string) (string, bool) {
	if s.Inc.EnableFingerprint {
...
func (s *inceptionCore) saveFingerprint(sqlId string) {
	if s.Inc.EnableFingerprint && sqlId != "" {
...
func (s *inceptionCore) addSplitNode(db, tableName string, isDML bool, stmtNode ast.StmtNode, currentSql string) {
...
// addNewSplitRow 添加新的split分隔节点
func (s *inceptionCore) addNewSplitNode() {
...
func (s *inceptionCore) checkSetStmt(node *ast.SetStmt) {
...
func (s *inceptionCore) IgnoreCase() bool {
	return s.LowerCaseTableNames > 0
}

// getErrorMessage 获取审核信息
func (s *inceptionCore) getErrorMessage(code ErrorCode) string {
	return GetErrorMessage(code, s.Inc.Lang)
}

func NewInception() *inceptionCore {
	return &inceptionCore{
		parser:      parser.New(),
...
// init 初始化map
func (s *inceptionCore) init() error {
	if s.opt == nil {
		return errors.New("未配置数据源信息!")
	}
