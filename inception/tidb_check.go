...
func (s *inceptionCore) checkContainDotColumn(stmt *ast.CreateTableStmt) {
...
func (s *inceptionCore) checkAutoIncrement(stmt *ast.CreateTableStmt) {
	var (
		isKey            bool
		count            int
...
func (s *inceptionCore) checkAutoIncrementOp(colDef *ast.ColumnDef, num int) (bool, error) {
	var hasAutoIncrement bool
...
func (s *inceptionCore) checkDuplicateColumnName(indexColNames []*ast.IndexColName) {
...
func (s *inceptionCore) checkIndexInfo(tableName, indexName string, indexColNames []*ast.IndexColName) {
...
func (s *inceptionCore) isInvalidDefaultValue(colDef *ast.ColumnDef) bool {
	tp := colDef.Tp
...
func (s *inceptionCore) checkCreateTableGrammar(stmt *ast.CreateTableStmt) {
	tName := stmt.Table.Name.String()
...
func (s *inceptionCore) checkColumn(colDef *ast.ColumnDef) error {
	// Check column name.
...
// func (s *Inception) checkNonUniqTableAlias(stmt *ast.Join, tableAliases map[string]interface{}) {
...
func (s *inceptionCore) checkTableAliasDuplicate(node ast.ResultSetNode, tableAliases map[string]interface{}) {
	switch x := node.(type) {
	case *ast.Join:
...
func (s *inceptionCore) checkOnlyFullGroupByWithOutGroupClause(fields []*ast.SelectField) error {
	var (
...
func (s *inceptionCore) checkOnlyFullGroupByWithGroupClause(sel *ast.SelectStmt, tables []*TableInfo) error {
